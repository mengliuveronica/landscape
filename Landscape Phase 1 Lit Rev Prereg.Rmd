...
What is the conceptual knowledge structure (e.g., themes and trends) of the OS literature?",
    ...
    funding = "None",
    cois = "None",
    overlapping_authorships = "The list of overlapping authorships (i.e., authors will be provided in the form of supplementary materials to our research output.",
