...
prereg_specify(
    ...
    authors = "Meng Liu, Alexander Hart, Aleksandra Lazić, Malgorzata Lagisz, Tamara Kalandadze, Bradley Baker, Mahmoud Elsherif, Sandra Grinschgl, Flávio Azevedo",
...
3. Piloting
    - Screening piloting 
    - Tagging piloting
4. Update preregistration based on piloting
5. Screening 
6. Tagging
7. Synthesis 
...
What is the conceptual knowledge structure (e.g., themes and trends) of the OS literature?",
    ...
    funding = "None",
    cois = "None",
    overlapping_authorships = "The list of overlapping authorships will be updated after data collection in the form of supplementary materials.",
